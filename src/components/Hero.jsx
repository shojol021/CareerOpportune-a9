        ...
        <div className='m-5 md:m-9'>
            <div className='flex flex-col-reverse md:flex-row justify-between items-center md:mb-9 pb-9'>
                <div className='flex flex-col justify-center md:w-1/2'>
                    ...
                    <p className='w-3/4 text-gray-500 my-3'>Explore thousands of job opportunities with all the information you need. Its your future. Come find it. Manage all your job application from start to finish.</p>
